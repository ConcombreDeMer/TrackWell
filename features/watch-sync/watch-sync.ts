...
const isNativeWatchSyncAvailable =
  Platform.OS === "ios" && typeof nativeModule?.publishSession === "function";
const nativeEmitter =
  Platform.OS === "ios" && nativeModule ? new NativeEventEmitter(nativeModule as never) : null;
